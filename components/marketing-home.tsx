  ...
  return (
    <div className="bg-bg text-fg">
      ...
      <section id="team" className="relative scroll-mt-24 overflow-hidden border-b border-white/12">
        ...
        <div className="relative mx-auto grid w-full max-w-content gap-12 px-6 py-14 lg:grid-cols-[0.72fr_1.28fr] lg:items-center lg:py-20">
          <div className="space-y-5">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {teamArchetypes.map((archetype) => (
              <article key={archetype.title} className="min-h-64 border border-white/18 bg-black/20 p-7 transition duration-150 hover:border-signal/45 hover:bg-white/[0.025] sm:p-8">
                <h3 className="font-display text-2xl leading-tight text-fg">{archetype.title}</h3>
                <p className="mt-6 text-sm leading-7 text-muted">{archetype.body}</p>
              </article>
            ))}
          </div>
        </div>
